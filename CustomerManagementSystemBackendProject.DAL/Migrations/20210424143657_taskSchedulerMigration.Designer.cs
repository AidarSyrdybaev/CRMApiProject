...
namespace CustomerManagementSystemBackendProject.DAL.Migrations
{
    ...
    [Migration("20210424143657_taskSchedulerMigration")]
    partial class taskSchedulerMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerManagementSystemBackendProject.DAL.Entities.Notify", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Notify");
                });
            ...
            modelBuilder.Entity("CustomerManagementSystemBackendProject.DAL.Entities.ChosenLeadsNotify", b =>
                {
                    b.HasBaseType("CustomerManagementSystemBackendProject.DAL.Entities.Notify");

                    b.Property<int>("ChosenLeadId")
                        .HasColumnType("integer");

                    b.HasIndex("ChosenLeadId");

                    b.HasDiscriminator().HasValue("ChosenLeadsNotify");
                });

            modelBuilder.Entity("CustomerManagementSystemBackendProject.DAL.Entities.LeadsNotify", b =>
                {
                    b.HasBaseType("CustomerManagementSystemBackendProject.DAL.Entities.Notify");
                    ...
                    b.HasDiscriminator().HasValue("LeadsNotify");
                });
            ...
            modelBuilder.Entity("CustomerManagementSystemBackendProject.DAL.Entities.ChosenLeadsNotify", b =>
                {
                    b.HasOne("CustomerManagementSystemBackendProject.DAL.Entities.ChosenLead", "ChosenLead")
                        .WithMany()
                        .HasForeignKey("ChosenLeadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChosenLead");
                });
